	...
	<view class="search">
		<view class="searchWrap">
			<view class="searchInput" >
				<u--input style="width: 100%;" @input="keyWordInput"
		...
		<template v-show="!hasPost">
			<scroll-view :scroll-y="scrollY" :style="{'height':' 100vh','width': '750rpx'}">
		...
		<view class="popupList" v-show="popupShow">
			<view class="keyWordList" v-if="predict_villa && predict_villa.villa">
				<view class="listItems">
					<image :src="predict_villa.villa.villa_avatar_url" mode="heightFix" class="image"></image>
					<view class="message">
						<view class="name">
			...
			<view class="keyWordList" v-if="predict_user">
				<view  class="listItems">
					<image :src="predict_user.avatar_url" mode="heightFix" class="image"></image>
					<view class="message">
						<view class="name">
			...
			<view class="keyWordList" v-if="predict_topic">
				<view class="listItems">
					<image :src="predict_topic.cover" mode="heightFix" class="image"></image>
					<view class="message">
						<view class="name">
							{{predict_topic.name}}
						</view>
